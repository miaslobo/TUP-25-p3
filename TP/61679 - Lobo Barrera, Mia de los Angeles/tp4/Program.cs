...
// ────────────────────────────────
// DbContext extendido con relaciones
// ────────────────────────────────
public class AppDbContext : DatosContexto {
...
static void RendirExamen(AppDbContext db) {
    ...
    // Corregido: primero se trae todo a memoria, luego se mezcla
